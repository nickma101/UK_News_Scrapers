...
ENV_OG = "6553e18c51ac3334da2ee117"
ENV_RW = "6553e27851ac3334e4e1e481"
POPULAR = "65520b4651ac331a8f49acf3"
...
# List of user IDs for each group
# WEEK1_GROUP1 = []
# WEEK1_GROUP2 = []
# WEEK1_GROUP3 = []
# WEEK1_GROUP4 = []
...
def write_articles(news_collection):
    ...
    filename = "news_articles" + dateString + ".json"
    desired_dir = "data"
...
def write_recommendations(recommendation_list):
    ...
    dateString = str(DATE)[:10]
    filename = "recommendation_list" + dateString + ".json"
    desired_dir = "data"
    full_path = os.path.join(desired_dir, filename)
...
def randomize_aricles(article_collection):
...
def main():
    ...
    article_selection = randomize_aricles(article_collection)
